...
const BlogSection:FC = () => {
    ...
    const getPopularBlogs = async () => {
        try{
            const response = await fetch(`https://relieved-harmony-production.up.railway.app/api/blog/get-popular/${popularAmount}`, {
                method: 'GET',
                headers: {
    ...
    const getNewestBlogs = async () => {
        try{
            const response = await fetch(`https://relieved-harmony-production.up.railway.app/api/blog/get-newest/${newAmount}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Access-Control-Allow-Origin':'*',
